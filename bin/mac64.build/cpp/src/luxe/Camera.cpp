...
{
		HX_STACK_FRAME("luxe.Camera","set_rotation_from_transform",0xfae455ea,"luxe.Camera.set_rotation_from_transform","luxe/Camera.hx",295,0xd52a0e40)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("luxe.Camera","set_scale_from_transform",0x39fbfb7a,"luxe.Camera.set_scale_from_transform","luxe/Camera.hx",305,0xd52a0e40)
		HX_STACK_THIS(this)
		...
		if ((tmp2)){
			...
			if ((tmp5)){
				...
				HX_STACK_LINE(310)
				Dynamic tmp7 = _this->_scale_change_dyn();		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(310)
				::phoenix::Vector_obj::Listen(tmp6,tmp7);
				HX_STACK_LINE(310)
				{
					HX_STACK_LINE(310)
					bool tmp8 = (_this->scale_changed != null());		HX_STACK_VAR(tmp8,"tmp8");
					HX_STACK_LINE(310)
					bool tmp9;		HX_STACK_VAR(tmp9,"tmp9");
					HX_STACK_LINE(310)
					if ((tmp8)){
...
{
		HX_STACK_FRAME("luxe.Camera","shake",0xb1becc15,"luxe.Camera.shake","luxe/Camera.hx",316,0xd52a0e40)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("luxe.Camera","update",0x3f133dda,"luxe.Camera.update","luxe/Camera.hx",324,0xd52a0e40)
		HX_STACK_THIS(this)
		HX_STACK_ARG(dt,"dt")
		HX_STACK_LINE(327)
