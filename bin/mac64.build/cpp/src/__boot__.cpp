...
::luxe::collision::sat::Common_obj::__register();
...
::DynamicShape_obj::__register();
::DynamicController_obj::__register();
::luxe::Component_obj::__register();
::luxe::ID_obj::__register();
::Date_obj::__register();
::CreatureData_obj::__register();
