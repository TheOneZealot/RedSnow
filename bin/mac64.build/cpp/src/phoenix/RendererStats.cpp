...
{
HX_STACK_FRAME("phoenix.RendererStats","new",0x1cd0e80f,"phoenix.RendererStats.new","phoenix/Renderer.hx",402,0x3d4c7b7b)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(411)
...
{
		HX_STACK_FRAME("phoenix.RendererStats","reset",0xee7deb3e,"phoenix.RendererStats.reset","phoenix/Renderer.hx",413,0x3d4c7b7b)
		HX_STACK_THIS(this)
		HX_STACK_LINE(414)
		this->geometry_count = (int)0;
		HX_STACK_LINE(415)
...
::String RendererStats_obj::toString( ){
	HX_STACK_FRAME("phoenix.RendererStats","toString",0xe4927e9d,"phoenix.RendererStats.toString","phoenix/Renderer.hx",422,0x3d4c7b7b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(424)
