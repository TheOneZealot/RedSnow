...
int ArrayBufferIO_obj::getInt16( Array< unsigned char > buffer,int byteOffset){
	HX_STACK_FRAME("snow.api.buffers.ArrayBufferIO","getInt16",0x047ebfe7,"snow.api.buffers.ArrayBufferIO.getInt16","snow/api/buffers/ArrayBufferIO.hx",48,0x5a87299c)
...
int ArrayBufferIO_obj::getInt16_BE( Array< unsigned char > buffer,int byteOffset){
	HX_STACK_FRAME("snow.api.buffers.ArrayBufferIO","getInt16_BE",0x36fb3a5b,"snow.api.buffers.ArrayBufferIO.getInt16_BE","snow/api/buffers/ArrayBufferIO.hx",54,0x5a87299c)
	HX_STACK_ARG(buffer,"buffer")
	HX_STACK_ARG(byteOffset,"byteOffset")
	HX_STACK_LINE(56)
	int tmp = ::__hxcpp_memory_get_i16(buffer,byteOffset);		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("snow.api.buffers.ArrayBufferIO","setInt16",0xb2dc195b,"snow.api.buffers.ArrayBufferIO.setInt16","snow/api/buffers/ArrayBufferIO.hx",62,0x5a87299c)
		HX_STACK_ARG(buffer,"buffer")
		HX_STACK_ARG(byteOffset,"byteOffset")
...
{
		HX_STACK_FRAME("snow.api.buffers.ArrayBufferIO","setInt16_BE",0x41684167,"snow.api.buffers.ArrayBufferIO.setInt16_BE","snow/api/buffers/ArrayBufferIO.hx",68,0x5a87299c)
		HX_STACK_ARG(buffer,"buffer")
		HX_STACK_ARG(byteOffset,"byteOffset")
		HX_STACK_ARG(value,"value")
		HX_STACK_LINE(68)
