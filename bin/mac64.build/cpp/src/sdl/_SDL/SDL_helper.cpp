...
{
		HX_STACK_FRAME("sdl._SDL.SDL_helper","quit",0x7fc39fac,"sdl._SDL.SDL_helper.quit","sdl/SDL.hx",1266,0x14b7af17)
		HX_STACK_LINE(1267)
...
int SDL_helper_obj::add_timer( int interval,Dynamic callback,Dynamic userdata){
	HX_STACK_FRAME("sdl._SDL.SDL_helper","add_timer",0xe079c6ea,"sdl._SDL.SDL_helper.add_timer","sdl/SDL.hx",1279,0x14b7af17)
	...
	struct _Function_1_1{
		inline static Dynamic Block( Dynamic &callback,int &_timerid,Dynamic &userdata,int &interval){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","sdl/SDL.hx",1288,0x14b7af17)
			{
...
bool SDL_helper_obj::remove_timer( int _timerid){
	HX_STACK_FRAME("sdl._SDL.SDL_helper","remove_timer",0x0cce3327,"sdl._SDL.SDL_helper.remove_timer","sdl/SDL.hx",1299,0x14b7af17)
...
int SDL_helper_obj::timer_callback( int _timerid){
	HX_STACK_FRAME("sdl._SDL.SDL_helper","timer_callback",0x904de6dc,"sdl._SDL.SDL_helper.timer_callback","sdl/SDL.hx",1315,0x14b7af17)
	HX_STACK_ARG(_timerid,"_timerid")
	HX_STACK_LINE(1317)
	::haxe::ds::IntMap tmp = ::sdl::_SDL::SDL_helper_obj::timers;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(1317)
...
int SDL_helper_obj::add_event_watch( Dynamic func,Dynamic userdata){
	HX_STACK_FRAME("sdl._SDL.SDL_helper","add_event_watch",0x53e2a60f,"sdl._SDL.SDL_helper.add_event_watch","sdl/SDL.hx",1358,0x14b7af17)
	...
	struct _Function_1_1{
		inline static Dynamic Block( Dynamic &func,int &_watchid,Dynamic &userdata){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","sdl/SDL.hx",1367,0x14b7af17)
			{
				hx::Anon __result = hx::Anon_obj::Create();
...
{
		HX_STACK_FRAME("sdl._SDL.SDL_helper","del_event_watch",0x0386c4b9,"sdl._SDL.SDL_helper.del_event_watch","sdl/SDL.hx",1377,0x14b7af17)
		HX_STACK_ARG(func,"func")
		HX_STACK_LINE(1379)
...
int SDL_helper_obj::event_watch_callback( int _watchid,::cpp::Reference<SDL_Event> _event){
	HX_STACK_FRAME("sdl._SDL.SDL_helper","event_watch_callback",0xbb641097,"sdl._SDL.SDL_helper.event_watch_callback","sdl/SDL.hx",1396,0x14b7af17)
...
struct _Function_0_1{
	inline static ::haxe::ds::IntMap Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","sdl/SDL.hx",1276,0x14b7af17)
		{
			HX_STACK_LINE(1276)
...
struct _Function_0_2{
	inline static ::haxe::ds::IntMap Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","sdl/SDL.hx",1354,0x14b7af17)
		{
			HX_STACK_LINE(1354)
			::haxe::ds::IntMap tmp = ::haxe::ds::IntMap_obj::__new();		HX_STACK_VAR(tmp,"tmp");
			HX_STACK_LINE(1354)
